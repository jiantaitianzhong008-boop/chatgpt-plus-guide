# MuyuGPT AI订阅指南目录｜GPT充值、Claude、Gemini、Grok

MuyuGPT AI订阅知识库，整理 ChatGPT / GPT充值、Claude、Gemini、Grok 等主流 AI 服务的国内购买、套餐比较、支付失败、账号安全、取消订阅与第三方订阅说明。
...
- [Claude充值](#claude充值)
- [Gemini / Google AI Pro](#gemini--google-ai-pro)
- [Grok / SuperGrok充值](#grok--supergrok充值)
- [常见搜索主题](#常见搜索主题)
- [关于 MuyuGPT](#关于-muyugpt)
...
- [2026 Grok充值 / SuperGrok国内购买指南](./grok/supergrok-alipay-wechat-recharge.md)

## SuperGrok套餐与产品介绍

- [SuperGrok是什么？功能、价格与适合人群指南](./grok/supergrok-guide.md)

## 取消订阅与自动续费

- [SuperGrok怎么取消？Grok关闭自动续费指南](./grok/supergrok-cancel.md)
...
- **ChatGPT还是Claude** → [ChatGPT Plus和Claude Pro对比](./chatgpt/chatgpt-plus-vs-claude-pro.md)
- **ChatGPT还是Gemini** → [ChatGPT和Gemini对比](./chatgpt/chatgpt-vs-gemini.md)
...
- **Gemini充值 / Google AI Pro购买** → [Gemini国内购买指南](./gemini/gemini-ai-pro-alipay-wechat-recharge.md)
- **Google AI Pro多少钱** → [Gemini / Google AI Pro价格指南](./gemini/gemini-ai-pro-price-guide.md)
- **Google AI Pro是什么** → [Google AI Pro功能与适合人群](./gemini/google-ai-pro-guide.md)
- **Gemini代充安全吗** → [Gemini代充与Google账号安全指南](./gemini/gemini-recharge-safety.md)
- **Google AI Pro取消续费** → [Google AI Pro取消订阅指南](./gemini/google-ai-pro-cancel.md)

## Grok / SuperGrok

- **Grok充值 / SuperGrok充值** → [Grok / SuperGrok国内购买指南](./grok/supergrok-alipay-wechat-recharge.md)
- **SuperGrok是什么 / SuperGrok多少钱** → [SuperGrok功能、价格与适合人群](./grok/supergrok-guide.md)
- **SuperGrok取消续费** → [SuperGrok取消订阅指南](./grok/supergrok-cancel.md)
...
| AI服务 | 当前套餐与服务说明 |
| --- | --- |
| ChatGPT Plus / Pro | [查看 ChatGPT 套餐](https://muyugpt.com/chatgpt) |
| Claude Pro / Max | [查看 Claude 套餐](https://muyugpt.com/claude) |
| Gemini / Google AI Pro | [查看 Gemini 套餐](https://muyugpt.com/gemini) |
| Grok / SuperGrok | [查看 Grok 套餐](https://muyugpt.com/grok) |
...
本文出现的 ChatGPT、GPT、Claude、Gemini、Google AI Pro、Grok、SuperGrok、OpenAI、Anthropic、Google、xAI、X 等名称，仅用于说明对应产品和服务。

各 AI 厂商的产品名称、套餐、价格、权益、支付方式、地区可用性和订阅政策可能发生变化，请以对应厂商当前官方信息为准。

MuyuGPT 自身商品、人民币价格、付款方式、使用周期、交付方式和售后规则，以 MuyuGPT 当前产品页面及实际订单页面为准。
